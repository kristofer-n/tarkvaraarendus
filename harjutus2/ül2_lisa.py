...
# lisab mõõga
mõõk = pygame.image.load("harjutus2/img/mõõk.png")
mõõk = pygame.transform.scale(mõõk, [150, 150])
mõõk = pygame.transform.rotate(mõõk, -45)
screen.blit(mõõk,[480,100])
...
# lisab tordi 
tort = pygame.image.load("harjutus2/img/tort.png")
tort = pygame.transform.scale(tort, [100, 100])
screen.blit(tort,[350,200])
...
# lisab vikk100 logo
vikk = pygame.image.load("harjutus2/img/vikk.png")
vikk = pygame.transform.scale(vikk, [230, 65])
