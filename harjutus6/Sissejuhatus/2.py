...
# MUUSIKA 
sounds = ['bg.mp3', 'bg2.mp3']
pygame.mixer.music.load('harjutus6/Sissejuhatus/music/'+random.choice(sounds))
...
playerImage = pygame.image.load("harjutus6/Sissejuhatus/img/knight.png")
...
enemyImage = pygame.image.load('harjutus6/Sissejuhatus/img/enemy.png')
...
while not gameover:
    ...
    for enemy in enemies[:]:
        if player.colliderect(enemy):
            ...
            score += 1
            hit_sound = pygame.mixer.Sound('harjutus6/Sissejuhatus/music/hit.wav')
